...
<div
  className="h-[30px] w-[121.8px] flex flex-col items-start relative isolate"
...
>
  <div className="w-full h-full absolute top-[0px] left-[-4px] flex flex-col items-start gap-px z-[0] shrink-0">
    ...
    <div className="flex flex-col items-start">
      <h3
        className="m-0 tracking-[3.6px] leading-5 uppercase font-bold text-white mq450:text-base mq450:leading-4"
        style={{ fontFamily: "Inter, sans-serif" }}
      >
        SIXSENCE
      </h3>
    ...
    <div
      className="flex flex-col items-start text-[9px] text-[#ffa040]"
      style={{ fontFamily: "Inter, sans-serif" }}
    >
