const ContainermarginaccueilMobile = () => {
  return (
    <div className="w-full flex flex-col items-center px-4 py-14 text-left text-[#ffb347] font-['JetBrains_Mono']">

      {/* HEADER */}
      <div className="w-full max-w-[420px] flex flex-col items-center pb-10">
      ...
      {/* FOOTER */}
      <div className="w-full max-w-[420px] flex flex-col items-center pt-10 border-t border-[rgba(232,160,32,0.07)]">
