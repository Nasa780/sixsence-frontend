...
const Profile11: NextPage = () => {
  return (
    <div className="max-w-[1200px] flex flex-col items-start py-5 px-6 box-border gap-4 leading-[normal] tracking-[normal] text-left text-[13px] text-[#94a3b8] font-[Inter]">
      ...
      <header className="self-stretch rounded-xl bg-[#18181c] border-[#2a2a30] border-solid border-[1px] flex flex-col items-center pt-10 px-6 pb-8 relative isolate gap-2.5 text-left text-xs text-[#6b7280] font-[Inter] mq450:pt-[26px] mq450:pb-[21px] mq450:box-border">
        ...
        />
        <h3 className="m-0 relative text-[22px] leading-[33px] font-bold font-[inherit] text-[#fff] z-[2] shrink-0">
          NASA
        </h3>
        ...
        <div className="w-[153px] h-6 flex items-center gap-2.5 z-[4] shrink-0">
          ...
          <div className="h-6 flex flex-col items-start text-base text-[#2a2a30]">
            <h2 className="m-0 relative text-[length:inherit] leading-6 font-normal font-[inherit]">
              |
            </h2>
          </div>
        ...
        <div className="flex items-center justify-center pt-1 px-0 pb-0 gap-2 z-[5] shrink-0 text-[#4ade80]">
          <div className="self-stretch rounded-md bg-[#14532d] border-[#166534] border-solid border-[1px] flex items-center py-[5px] px-3 gap-[5px]">
            <Image
              className="h-3 w-3 relative"
              loading="lazy"
              width={12}
          ...
          <button className="cursor-pointer border-[#2a2a30] border-solid border-[1px] py-[5px] px-3 bg-[#1c1c22] self-stretch flex-1 rounded-md flex items-center gap-[5px]">
            <Image
              className="h-3 w-3 relative"
              width={12}
              height={12}
          ...
          <div className="self-stretch rounded-md bg-[#1c1c22] border-[#2a2a30] border-solid border-[1px] flex items-center py-[5px] px-3 gap-[5px] text-[#cbd5e1]">
            <Image
              className="h-3 w-3 relative"
              loading="lazy"
              width={12}
        ...
        <div className="w-[177px] h-10 flex flex-col items-start pt-1 px-0 pb-0 box-border z-[6] shrink-0">
          <button className="cursor-pointer border-[#2a2a30] border-solid border-[1px] py-[7px] px-3.5 bg-[#1c1c22] w-[177px] h-9 rounded-lg box-border flex items-center gap-2">
            <div className="h-5 flex flex-col items-start">
      ...
      <section className="self-stretch rounded-xl bg-[#18181c] border-[#2a2a30] border-solid border-[1px] flex flex-col items-start py-5 px-6 text-left text-[11px] text-[#94a3b8] font-[Rajdhani]">
        ...
        <div className="self-stretch flex flex-col items-start pt-4 px-0 pb-0 text-[22px] text-[#fff] font-[Inter]">
          <div className="self-stretch flex items-start justify-center flex-wrap content-start py-0 pl-0 pr-0.5 gap-2.5">
            <div className="h-[75px] flex-1 shadow-[0px_0px_12px_rgba(79,_195,_247,_0.35)] rounded-[10px] bg-[#111114] border-[rgba(79,195,247,0.27)] border-solid border-[1px] box-border overflow-hidden flex flex-col items-center py-3.5 pl-2 pr-[7px] relative isolate gap-2 min-w-[63px] shrink-0">
              ...
              <div className="self-stretch flex flex-col items-center z-[1] shrink-0">
                <h3 className="m-0 w-[31px] relative text-[length:inherit] leading-[22px] font-normal font-[inherit] inline-block mq450:text-lg mq450:leading-[18px]">
                  🎯
                </h3>
              </div>
            ...
            <div className="h-[75px] flex-1 shadow-[0px_0px_12px_rgba(251,_146,_60,_0.35)] rounded-[10px] bg-[#111114] border-[rgba(251,146,60,0.27)] border-solid border-[1px] box-border overflow-hidden flex flex-col items-center py-3.5 px-2 relative isolate gap-2 min-w-[54px] shrink-0">
            ...
            <div className="h-[75px] flex-1 shadow-[0px_0px_12px_rgba(192,_132,_252,_0.35)] rounded-[10px] bg-[#111114] border-[rgba(192,132,252,0.27)] border-solid border-[1px] box-border overflow-hidden flex flex-col items-center py-3.5 px-2 relative isolate gap-2 min-w-[46px] shrink-0">
            ...
            <div className="h-[75px] flex-1 shadow-[0px_0px_12px_rgba(250,_204,_21,_0.35)] rounded-[10px] bg-[#111114] border-[rgba(250,204,21,0.27)] border-solid border-[1px] box-border overflow-hidden flex flex-col items-center py-3.5 pl-2 pr-[7px] relative isolate gap-2 min-w-[46px] shrink-0">
            ...
            <div className="h-[75px] flex-1 shadow-[0px_0px_12px_rgba(74,_222,_128,_0.35)] rounded-[10px] bg-[#111114] border-[rgba(74,222,128,0.27)] border-solid border-[1px] box-border overflow-hidden flex flex-col items-center py-3.5 pl-2 pr-[7px] relative isolate gap-2 min-w-[47px] shrink-0">
            ...
            <div className="h-[75px] flex-1 shadow-[0px_0px_12px_rgba(55,_65,_81,_0.2)] rounded-[10px] bg-[#111114] border-[rgba(55,65,81,0.27)] border-solid border-[1px] box-border overflow-hidden flex flex-col items-center py-3.5 px-2 relative isolate gap-2 min-w-[47px] shrink-0">
      ...
      <section className="self-stretch rounded-xl bg-[#18181c] border-[#2a2a30] border-solid border-[1px] box-border flex flex-col items-start justify-center py-5 px-6 gap-4 max-w-full text-left text-[11px] text-[#94a3b8] font-[Inter]">
        <div className="self-stretch flex items-center gap-2">
          <Image
            className="h-[18px] w-[18px] relative"
            loading="lazy"
        ...
        <div className="self-stretch flex flex-col items-start max-w-full text-center text-[10px] text-[#4b5563]">
          <div className="w-full h-40 relative overflow-hidden shrink-0 max-w-[1102px] mq1025:h-auto mq1025:min-h-[160px] mq1100:max-w-full">
            <Image
            ...
            <div className="absolute top-[134.6px] left-[29px] w-[1073.6px] flex items-center gap-px max-w-full mq1025:flex-wrap">
              ...
              <div className="flex-1 relative inline-block min-w-[269px] max-w-[274px]">
                5 jan
              </div>
              <div className="flex-1 relative text-left inline-block max-w-[145px]">
                8 jan
              </div>
              <div className="flex-1 relative inline-block max-w-[33px]">
                10 jan
              </div>
              <div className="flex-1 relative inline-block min-w-[258px] max-w-[264px]">
                12 jan
              </div>
              <div className="flex-1 relative inline-block max-w-[34px]">
                14 jan
              </div>
              <div className="flex-1 relative inline-block min-w-[258px] max-w-[263px]">
                16 jan
              </div>
              <div className="flex-1 relative inline-block max-w-[27px]">
                18 jan
              </div>
            </div>
