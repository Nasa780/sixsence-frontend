...
const Profile11: NextPage = () => {
  return (
    <div
      className="
      w-full max-w-[1600px] mx-auto flex flex-col items-start py-5 px-6 box-border gap-4 overflow-y-auto
      leading-[normal] tracking-[normal] text-left text-[13px] text-[#94a3b8] font-[Inter]

      /* --- SIX SENCE BACKGROUND --- */
      bg-[#090c10] relative
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 
        [background:
          linear-gradient(to_left,rgba(0,0,0,0.45),transparent_40%),
      ...
      <header
        ...
        text-left text-xs text-[#6b7280] font-[Inter]
        mq450:pt-[26px] mq450:pb-[21px] mq450:box-border
      "
      >
        ...
        <button
          className="
          cursor-pointer border-[rgba(215,170,40,0.11)] border-solid border-[1px]
          py-1.5 pl-3 pr-[11px] bg-[#1c1c22] h-8 absolute top-[16px] right-[18.2px]
          rounded-[7px] box-border flex items-start gap-1.5 whitespace-nowrap z-[20]
          hover:bg-[#4f4f54] hover:border-[#d7aa28]
        "
        >
          <Image
        ...
        <div className="flex items-center justify-center pt-1 px-0 pb-0 gap-2 z-[5] text-[#4ade80]">
          ...
          <div className="
            rounded-md bg-[#14532d] border-[#166534] border-solid border-[1px]
          ...
          <button
            className="
            cursor-pointer border-[rgba(215,170,40,0.11)] border-solid border-[1px]
            py-[5px] px-3 bg-[#1c1c22] flex-1 rounded-md flex items-center gap-[5px]
          ...
          <div
            className="
            rounded-md bg-[#1c1c22] border-[rgba(215,170,40,0.11)] border-solid border-[1px]
        ...
        <div className="w-[177px] h-10 flex flex-col items-center pt-1 px-0 pb-0 z-[6]">
          <button
            className="
            cursor-pointer 
            border-[rgba(215,170,40,0.11)] border-solid border-[1px] 
            py-[7px] px-3.5 
            bg-[#060709] 
            w-[177px] h-9 
            rounded-lg 
        ...
        <div className="w-[214px] h-5 flex flex-col items-center pt-0.5 px-0 pb-0 z-[7]">
          <div className="relative leading-[18px] text-[#e2e8f0]">
      ...
      <section
        ...
        text-left text-[11px] text-[#94a3b8] font-[Inter]
      "
      >
        <div className="self-stretch flex items-center gap-2">
          ...
          <div className="h-[17px] flex flex-col items-start">
            <b className="relative tracking-[1.1px] leading-[16.5px] uppercase text-[#e2e8f0]">
        ...
        <div className="self-stretch flex flex-col items-start pt-4 px-0 pb-0 text-[26px] text-[#fff]">
          <div className="self-stretch flex items-center justify-center flex-wrap content-center py-0 pl-0 pr-0.5 gap-3">
            ...
            <div
              ...
              flex flex-col items-center py-[18px] px-4 gap-1.5 
              min-w-[105px] shrink-0
            "
            >
              <Image
                className="w-7 h-7 relative shadow-[0_0_5px_rgba(215,170,40,0.45)]"
                loading="lazy"
                width={28}
                height={28}
                sizes="100vw"
              ...
              />
              <div className="w-[33px] h-[26px] flex flex-col items-center">
                <h1 className="m-0 relative leading-[26px] font-bold mq450:text-[21px] mq450:leading-[21px]">
                  37
                </h1>
              </div>
            ...
            <div
              ...
              box-border overflow-hidden 
              flex flex-col items-center py-[18px] px-4 gap-1.5 
              min-w-[119px] shrink-0 text-[#4ade80]
            "
            >
              <Image
              ...
              />
              <div className="w-[33px] h-[26px] flex flex-col items-center">
                <h2 className="m-0 relative leading-[26px] font-bold mq450:text-[21px] mq450:leading-[21px]">
                  22
                </h2>
              </div>
              <div className="relative text-[11px] leading-[16.5px] text-[#6b7280]">
            ...
            <div
              ...
              box-border overflow-hidden 
              flex flex-col items-center py-[18px] px-4 gap-1.5 
              min-w-[115px] shrink-0 text-[#f87171]
            "
            >
              <Image
                className="w-7 h-7 relative"
              ...
              />
              <div className="w-[30px] h-[26px] flex flex-col items-center">
                <h2 className="m-0 relative leading-[26px] font-bold mq450:text-[21px] mq450:leading-[21px]">
                  15
                </h2>
              </div>
            ...
            <div
              ...
              box-border overflow-hidden 
              flex flex-col items-center py-[18px] px-4 gap-1.5 
              min-w-[117px] shrink-0 text-[#fb923c]
            "
            >
              <Image
                className="w-7 h-7 relative"
                ...
                src="/TrendUpIcon.svg"
              />
              <div className="w-[60px] h-[26px] flex flex-col items-center">
                <h2 className="m-0 relative leading-[26px] font-bold inline-block min-w-[60px] mq450:text-[21px] mq450:leading-[21px]">
                  59%
                </h2>
              </div>
              <div className="relative text-[11px] leading-[16.5px] text-[#6b7280]">
...
<div
  className="
  self-stretch h-[89px] rounded-xl 
  [background:linear-gradient(135deg,#1c0f00,#2d1700_50%,#1a0e00)]
  border-[#78350f] border-solid border-[1px]
  box-border flex items-center py-5 px-7 gap-3.5
  text-lg text-[#fff]
"
>
  <Image
  ...
  <div className="flex flex-col items-start">
    <div className="flex flex-col items-start">
      <h2 className="m-0 relative leading-[27px] font-bold">
...
<section
  className="
  self-stretch rounded-xl bg-[#18181c]
  border-[#2a2a30] border-solid border-[1px]
  box-border flex flex-col items-start py-5 px-6
  max-w-full text-left text-[11px] text-[#94a3b8] font-[Inter]
"
>
  ...
  <div className="self-stretch flex flex-col items-center pt-4 px-0 pb-0 box-border max-w-full text-xs text-[#6b7280]">
    <div
      className="
      w-full h-14 rounded-lg bg-[#111114]
      border-[#2a2a30] border-solid border-[1px]
      box-border flex items-center flex-wrap content-center
      py-3 px-4 gap-2.5 max-w-full
    "
    >
      <button className="cursor-pointer [border:none] py-[3px] px-2.5 bg-[#14532d] h-[23px] rounded flex flex-col items-start hover:bg-[#3b7a54]">
        <b className="relative text-[11px] tracking-[0.33px] leading-[16.5px] text-[#4ade80]">
          Victoire
        </b>
      </button>

      <button className="cursor-pointer [border:none] py-[3px] px-2.5 bg-[#431407] h-[23px] rounded flex flex-col items-start hover:bg-[#75473b]">
        <div className="relative text-[11px] leading-[16.5px] font-semibold text-[#fb923c]">
      ...
      <button className="cursor-pointer border-[#7e22ce] border-solid border-[1px] py-[5px] px-3 bg-[#581c87] h-[30px] rounded-md flex items-center gap-[5px] hover:bg-[#8042ad] hover:border-[#a347f5]">
        <Image
          ...
          src="/Icon5.svg"
        />
        <div className="relative text-xs leading-[18px] font-semibold text-[#c084fc]">
          Voir détails
        </div>
      </button>
    </div>
...
<footer
  className="
  self-stretch h-[60px] rounded-xl bg-[#18181c]
  border-[#2a2a30] border-solid border-[1px]
  box-border flex flex-col items-start py-5 px-6
  text-left text-[11px] text-[#94a3b8] font-[Inter]
"
