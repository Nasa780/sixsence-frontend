...
const Profile1 = () => {
  return (
    <div className="w-[2174px] bg-[#141417] border-[#2a2a30] border-solid border-b-[1px] box-border max-w-full flex flex-col items-start leading-[normal] tracking-[normal] text-left text-xs text-[#fff] font-[Inter]">
