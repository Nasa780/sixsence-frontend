...
const NavigationaccueilMobile: NextPage = () => {
  return (
    <div className="w-full flex flex-col items-center py-12 px-4 text-center text-[10px] text-[#e8a020] font-['JetBrains_Mono']">

      {/* CARD */}
      <div className="w-full max-w-[360px] shadow-[0px_0px_40px_rgba(0,0,0,0.5)] [background:linear-gradient(145deg,#141311,#0f0e0c)] border border-[rgba(232,160,32,0.18)] rounded-lg flex flex-col items-center py-10 px-6">
